...
//+kubebuilder:webhook:path=/mutate-poison-venom-gule-gulzar-com-v1-clusterscan,mutating=true,failurePolicy=fail,sideEffects=None,groups=poison.venom.gule-gulzar.com,resources=clusterscans,verbs=create;update,versions=v1,name=mclusterscan.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-poison-venom-gule-gulzar-com-v1-clusterscan,mutating=false,failurePolicy=fail,sideEffects=None,groups=poison.venom.gule-gulzar.com,resources=clusterscans,verbs=create;update,versions=v1,name=vclusterscan.kb.io,admissionReviewVersions=v1
