...
import (
	...
	"github.com/adorigi/venom/internal/controller"
...
func init() {
	...
	utilruntime.Must(poisonv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1cb4de7b.venom.gule-gulzar.com",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&poisonv1.ClusterScan{}).SetupWebhookWithManager(mgr); err != nil {
